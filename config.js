...
window.GAME_CONFIG = {
    ...
    game: {
        ...
        winMessage: "Это было мощно!🔥<br>Ты покорил игру и сердце SUMMERLOVE — скидка 500₸ твоя по промокоду {PROMO_CODE}. Покажи промокод кассиру и получи скидку.<br><br>Күшті болды!🔥<br>Сен ойынды да, SUMMERLOVE жүрегін де бағындырдың — {PROMO_CODE} промокодымен 500₸ жеңілдік сенің қолыңда. Кассирге жарнамалық кодты көрсетіп, жеңілдік ал.",
        promoCode: "SUMMER",
